...
export class AuthService {
  ...
  private tokerExparationTimer: any
  ...
  logout() {
    ...
    if(this.tokerExparationTimer){
      clearTimeout(this.tokerExparationTimer)
    }
    this.tokerExparationTimer = null
  }

  autoLogout(expirationTime: number){
    console.log(expirationTime)
    this.tokerExparationTimer = setTimeout(()=>{
      this.logout()
    },expirationTime)
  }
